<template>
  <input
    ...
    @keydown="onKeyDown"
    @paste="onPaste"
    class="money-input money-input--vue-currency"
...
/** Форматирование в стиле Vue-Currency-Input: разделитель групп (пробел), суффикс валюты */
...
/** При фокусе — сырая строка (distraction-free); при blur — полный формат с валютой */
  ...
  if (parsedNumber !== null) {
    newInputString =
      props.decimalPlaces === 0
        ...
        : parsedNumber.toFixed(props.decimalPlaces);
  }
