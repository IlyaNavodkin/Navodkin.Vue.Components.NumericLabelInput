import type { IntlConfig } from './getLocaleConfig';
...
export const formatValue = (options: FormatValueOptions): string => {
  ...
  const intlSuffix = getSuffix(formatted, { groupSeparator: options.groupSeparator, decimalSeparator: options.decimalSeparator });
